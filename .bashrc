...
export MINGw_ROOT="$MSYS2_ROOT/mingw64"
export MSYS=winsymlinks:nativestrict

# add docker to bin
export PATH=$PATH:"/c/Program Files/Docker/Docker/resources/bin"

# This is for alacritty environment to put the mingw64 path before everything else
export PATH="$MSYS2_ROOT/usr/bin/:$PATH"
export PATH="$MINGW_ROOT/bin/:$PATH"
export PATH="/mingw64//bin/:$PATH"

export GOROOT=$MINGW_ROOT/lib/go
